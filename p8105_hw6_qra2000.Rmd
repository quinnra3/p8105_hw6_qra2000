...
Next, we propose a regression model based on a hypothesized structure for the factors that underly birthweight. My variables of interest are: family monthly income (in hundreds, rounded), average number of cigarettes smoked per day during pregnancy, and mother's weight gain during pregnancy (pounds).
